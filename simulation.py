...
# Images
W, H = 135, 120
START = pygame.transform.scale(pygame.image.load(os.path.join("assets", "start_img.png")), (W, H))
PAUSE = pygame.transform.scale(pygame.image.load(os.path.join("assets", "pause_img.png")), (W, H))
