...
&& rm -rf master.zip \
&& mkdir -p $1 \
&& cp -r $temporary_dir/covid-19_simulator-master $1/covid-19_simulator \
&& rm -rf $temporary_dir \
&& echo -e "\033[0;32mSuccessfully downloaded to $1/covid-19_simulator\033[0m" \
